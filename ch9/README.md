...
此章節內容為如何使用 kustomize 來簡化多個環境 yaml 設定檔。

相關指令內容，旨在模擬實務上所遇到的各種不同需求，利用 kustomize build 在 console 輸出 yaml 檔案，觀察其結果。

如需實際 apply / create 資源，需先確認該資源設定檔或 Image 是否存在。
